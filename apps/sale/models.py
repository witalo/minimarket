...
class ProductStore(models.Model):
    ...
    subsidiary_store = models.ForeignKey('SubsidiaryStore', verbose_name='Almacen sede', on_delete=models.CASCADE,
                                         related_name='stores')
    stock = models.DecimalField('Stock', max_digits=30, decimal_places=2, default=0)
...
class Kardex(models.Model):
    ...
    price_total = models.DecimalField('Precio total', max_digits=30, decimal_places=2, default=0)
